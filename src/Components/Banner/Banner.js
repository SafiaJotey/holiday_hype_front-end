          ...
          <div className="bg-dark  row d-flex  align-items-center justify-content-center w-100 ">
            <div className="col-md-6  p-4">
              ...
              <p className=" text-justify  px-4">
                Are you thinking about going on a long trip around the world,
                too, but don’t know how to go about planning such an endeavour?
                Read the article to find out a few most important things to know
                before going on a one-year trip around the world.
              </p>
